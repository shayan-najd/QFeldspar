...
realPartVar :: Var Prelude (Cmx -> Flt)
realPartVar = $(nat 0 "")

imagPartVar :: Var Prelude (Cmx -> Flt)
imagPartVar = $(nat 1 "")

eqlBolVar :: Var Prelude (Bol -> (Bol -> Bol))
eqlBolVar = $(nat 2 "")

eqlIntVar :: Var Prelude (Int -> (Int -> Bol))
eqlIntVar = $(nat 3 "")

eqlFltVar :: Var Prelude (Flt -> (Flt -> Bol))
eqlFltVar = $(nat 4 "")

ltdBolVar :: Var Prelude (Bol -> (Bol -> Bol))
ltdBolVar = $(nat 5 "")

ltdIntVar :: Var Prelude (Int -> (Int -> Bol))
ltdIntVar = $(nat 6 "")

ltdFltVar :: Var Prelude (Flt -> (Flt -> Bol))
ltdFltVar = $(nat 7 "")

addIntVar :: Var Prelude (Int -> (Int -> Int))
addIntVar = $(nat 8 "")

subIntVar :: Var Prelude (Int -> (Int -> Int))
subIntVar = $(nat 9 "")

mulIntVar :: Var Prelude (Int -> (Int -> Int))
mulIntVar = $(nat 10 "")

divIntVar :: Var Prelude (Int -> (Int -> Int))
divIntVar = $(nat 11 "")

addFltVar :: Var Prelude (Flt -> (Flt -> Flt))
addFltVar = $(nat 12 "")

subFltVar :: Var Prelude (Flt -> (Flt -> Flt))
subFltVar = $(nat 13 "")

mulFltVar :: Var Prelude (Flt -> (Flt -> Flt))
mulFltVar = $(nat 14 "")

divFltVar :: Var Prelude (Flt -> (Flt -> Flt))
divFltVar = $(nat 15 "")

addCmxVar :: Var Prelude (Cmx -> (Cmx -> Cmx))
addCmxVar = $(nat 16 "")

subCmxVar :: Var Prelude (Cmx -> (Cmx -> Cmx))
subCmxVar = $(nat 17 "")

mulCmxVar :: Var Prelude (Cmx -> (Cmx -> Cmx))
mulCmxVar = $(nat 18 "")

divCmxVar :: Var Prelude (Cmx -> (Cmx -> Cmx))
divCmxVar = $(nat 19 "")

andIntVar :: Var Prelude (Int -> (Int -> Int))
andIntVar = $(nat 20 "")

orIntVar :: Var Prelude (Int -> (Int -> Int))
orIntVar = $(nat 21 "")

xorIntVar :: Var Prelude (Int -> (Int -> Int))
xorIntVar = $(nat 22 "")

shrIntVar :: Var Prelude (Int -> (Int -> Int))
shrIntVar = $(nat 23 "")

shlIntVar :: Var Prelude (Int -> (Int -> Int))
shlIntVar = $(nat 24 "")

cmpIntVar :: Var Prelude (Int -> Int)
cmpIntVar = $(nat 25 "")

i2fVar :: Var Prelude (Int -> Flt)
i2fVar = $(nat 26 "")

cisVar :: Var Prelude (Flt -> Cmx)
cisVar = $(nat 27 "")

ilog2Var :: Var Prelude (Int -> Int)
ilog2Var = $(nat 28 "")

sqrtFltVar ::  Var Prelude (Flt -> Flt)
sqrtFltVar = $(nat 29 "")

memVar ::  Var Prelude (Ary Flt -> Ary Flt)
memVar = $(nat 30 "")

hshTblVar ::  Var Prelude (Ary Int)
hshTblVar = $(nat 31 "")
